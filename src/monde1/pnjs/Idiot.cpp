...
void Idiot::mise_a_jour_ia()
{
    ...
    Bonus *bonus_gauche = dynamic_cast<Bonus *> (gauche);
    ...
    Bonus * bonus_droite = dynamic_cast<Bonus *> (droite);
