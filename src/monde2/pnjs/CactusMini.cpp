...
void CactusMini::attaquer_joueur()
{
...
void CactusMini::mise_a_jour_ia()
{
    ...
    if(get_case()->get_case_info()._distance < max)
    {
        ...
        if((get_case()->get_case_gauche()->get_case_info()._distance >  get_case()->get_case_info()._distance) &&
                get_case()->get_case_gauche()->est_praticable())
            _derniere_direction = nsUtil::GAUCHE;
        if((get_case()->get_case_droite()->get_case_info()._distance >  get_case()->get_case_info()._distance) &&
                get_case()->get_case_droite()->est_praticable() )
                    _derniere_direction = nsUtil::DROITE;
        if((get_case()->get_case_haut()->get_case_info()._distance >  get_case()->get_case_info()._distance) &&
                get_case()->get_case_haut()->est_praticable())
                    _derniere_direction = nsUtil::HAUT;
        if((get_case()->get_case_bas()->get_case_info()._distance >  get_case()->get_case_info()._distance) &&
