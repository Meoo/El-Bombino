...
void CaisseSurvie::mise_a_jour_ia()
{
    ...
    if (get_case()->get_case_info()._distance < max)
    {
        ...
        if ((get_case()->get_case_gauche()->get_case_info()._distance
                ...
                && get_case()->get_case_info()._direction != nsUtil::GAUCHE
                && get_case()->get_case_info()._direction != nsUtil::DROITE)
        ...
        if ((get_case()->get_case_haut()->get_case_info()._distance
                ...
                && get_case()->get_case_info()._direction != nsUtil::BAS
                && get_case()->get_case_info()._direction != nsUtil::HAUT)
            bouger(nsUtil::HAUT);
