...
std::string nsUtil::SFKeyToString(sf::Keyboard::Key keycode) {
    switch (keycode) {
        ...
        case sf::Keyboard::LControl: return"Controle Gauche"; break;
        case sf::Keyboard::LShift: return"Maj Gauche"; break;
        case sf::Keyboard::LAlt: return"Alt Gauche"; break;
        case sf::Keyboard::LSystem: return"Windows"; break;
        case sf::Keyboard::RControl: return"Controle Droite"; break;
        case sf::Keyboard::RShift: return"Maj Droite"; break;
        case sf::Keyboard::RAlt: return"Alt Droite"; break;
        case sf::Keyboard::RSystem: return"Windows"; break;
        ...
        case sf::Keyboard::Space: return"Espace"; break;
        case sf::Keyboard::Return: return"Return"; break;
        case sf::Keyboard::Tab: return"Tabulation"; break;
        ...
        case sf::Keyboard::Left: return"Gauche"; break;
        case sf::Keyboard::Right: return"Droite"; break;
        case sf::Keyboard::Up: return"Haut"; break;
        case sf::Keyboard::Down: return"Bas"; break;
